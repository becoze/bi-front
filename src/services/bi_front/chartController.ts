...
/** genChartByYuAi POST /api/chart/gen */
export async function genChartByYuAiUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByYuAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseYuAiResponse_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByYuAiAsync POST /api/chart/gen/async */
export async function genChartByYuAiAsyncUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByYuAiAsyncUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseYuAiResponse_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartByYuAiAsyncMq POST /api/chart/gen/async/mq */
export async function genChartByYuAiAsyncMqUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartByYuAiAsyncMqUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseYuAiResponse_>('/api/chart/gen/async/mq', {
    method: 'POST',
    params: {
      ...params,
    },
